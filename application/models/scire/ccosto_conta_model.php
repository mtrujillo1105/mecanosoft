...
class Ccosto_conta_model extends CI_Model {
    ...
    public function select($filter,$default="",$value=""){
        ...
        if(count($ccostos)>1){
            ...
            {
                $indice1   = $valor->Codigo_Auxiliar2;
                $valor1    = utf8_encode($valor->cco_group);
                $arreglo[$indice1] = $valor1;
            }            
        }
        elseif(count($ccostos)==1){
            $indice1   = $ccostos->Codigo_Auxiliar2;
            $valor1    = utf8_encode($ccostos->cco_group);
            $arreglo[$indice1] = $valor1;
        }
        return $arreglo;
    }
