...
class Trazabilidad extends CI_Controller{
    ...
    public function editar($accion="n",$codigo="")
    {
        ...
        $arrGanchera          = array("0"=>"::Todos::","1"=>"Ganchera N°1","2"=>"Ganchera N°2","3"=>"Ganchera N°3","4"=>"Ganchera N°4","5"=>"Ganchera N°5","6"=>"Ganchera N°6","7"=>"Ganchera N°7","8"=>"Ganchera N°8","9"=>"Ganchera N°9","10"=>"Ganchera N°10");
        $arrOperacion         = array("0"=>"::Todos::","1"=>"Decapado","2"=>"Fluxeado","3"=>"Decapado","4"=>"Pre-calentado","5"=>"Galvanizado","6"=>"Despacho");
        ...
        $seloperacion         = form_dropdown('operacion',$arrOperacion,$lista->tipomaterial,"id='operacion' class='comboPequeno'");                 
        $data['titulo']       = "CONTROL DE PIEZAS";        
        ...
        $data['seloperacion'] = $seloperacion;  
        $data['oculto']       = form_hidden(array('accion'=>$accion,'codigo'=>$codigo));
        $this->load->view("produccion/trazabilidad_nuevo",$data);
    }
