...
<div class="case_botones">
    ...
    <div style="margin-top:5px;text-align:left;"><h2><?php echo $numeroOt." ".$direccionOt;?></h2></div>
        ...
        <table border='1' width='95%'>
            <tbody>
                <tr>
                    ...
                    <td>PESO<br>SOLICITADO TOTAL</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td align='right'><?php echo number_format($p_solicitado_total_total,2,",",".");?></td>
