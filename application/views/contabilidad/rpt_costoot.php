...
<!--<div title="Click para Cerrar" id="carga" style="cursor:pointer;border-radius:10px;-moz-border-radius:10px;-webkit-border-radius:10px;box-shadow:inset yellow 0px 0px 14px;background-image:url(http://www.puntroma.com/img/ico_cargando.gif);background-position:center;background-size:100%;background-color:#111111;width:300px;color:#fff;text-align:center;height:100px;padding:52px 12px 12px 12px;position:fixed;top:30%;left:40%;z-index:6;">TU TEXTO AQUI</div>
        ...
        <div class="header">REPORTE DE COSTOS POR OTs</div>
        <div class="case_top">
                ...
                <table width="100%" cellspacing="0" cellpadding="3" border="0" >
                    <tbody>
                        <tr>
                            ...
                            <td align="left">
                                <?php echo $seltipot;?>
                                <input type="text" name="ot" id="ot" style="width: 60px;"  readonly="readonly" class="cajaPequena" value="<?php echo $numeroot;?>" onclick="agrega_ot('');">                                
                            </td>   
...
<!--                                <input style="cursor:pointer" onclick ="blockui();$('#tipoexport').val('');" type="submit" value="Consultar"></input>                                -->
	...
	<div class="case_botones" style="width:20%;border:0px solid #000;float: left;">
            ...
            <ul class="lista_botones"><li id="excel" class="costos_x_ot">Ver Excel</li></ul>  
            <ul class="lista_botones"><li id="html" class="rpt_costoot">Ver Html</li></ul>              
	</div> 
		...
		<thead>
                <tr align='center' class='cabeceraTabla'>
                    ...
                    <td class="pa01" style="display:none;"><span>MATERIALES</span></td>
                    <td class="pa02" style="display:none;"><span>M.O.<br>DIRECTA</span></td>
                    <td class="pa03" style="display:none;"><span>SUBCONTRATOS</span></td>		
                    <td class="pa06" style="display:none;"><span>COSTO DEL RESIDENTE</span></td>	
                    <td class="pa07" style="display:none;"><span>ESTUDIOS Y PROYECTOS</span></td>		
                    <td class="pa04" style="display:none;"><span>ADMINIST.<BR>DIRECTA</span></td>
                    <td class="pa09" style="display:none;"><span>OTROS<BR>COSTOS DIRECTOS</span></td>	
                    <td class="pa08" style="display:none;"><span>TRANSPORTE</span></td>
                    <td class="pa10" style="display:none;"><span>CONTINGENCIA</span></td>
                    <td class="pa11" style="display:none;"><span>SERVICIOS<br>DIRECTOS</span></td>                            
                    <td class="pa12" style="display:none;"><span>TRANSPORTE</span></td>   
                    <td class="pa15" style="display:none;"><span>GALVANIZADO</span></td> 
                    <td class="pa13" style="display:none;"><span>GASTOS<BR>TESORERIA</span></td>
                    <td class="pa14" style="display:none;"><span>CAJA<br>CHICA</span></td>
                    <td>VALOR <BR> VENTA.</td>
