        ...
        <table width="100%" cellspacing="0" cellpadding="3" border="0">
            <THEAD>
                <tr class="cabeceraTabla">
                    ...
                    <td width="9%">NUMERO DOC</td>
                    <td width="9%">APELLIDOS Y NOMBRES</td>
                    <td width="9%">MONTO BRUTO</td>
                    <td width="20%">RETENCION EFECTUADA</td>
                    <td width="26%">MONTO NETO</td>
                    <td width="26%" colspan="3">ACCIONES</td>
                </tr>
            </THEAD>    
