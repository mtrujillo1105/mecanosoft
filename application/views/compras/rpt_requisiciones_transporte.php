...
<div id="container">
    ...
    <div class="case_top2">
        ...
        <form  class="frmTransporte"  method="post" enctype="multipart/form-data" id="frmTransporte">
            <table width="98%" cellspacing="0" cellpadding="3" border="0" style="margin-top:5px;">
                <tbody>
                    <tr>
						...
						<option value="http://localhost/mimco/index.php/compras/ocompra/indicador_requis_atendidas">Materiales</option>
						<option value="http://localhost/mimco/index.php/compras/ocompra/indicador_requis_transporte" selected>Transporte</option>
    ...
    <div class="case_botones">
        <ul class="lista_botones"><li id="salir" class="transporte">Salir</li></ul>          
        <ul class="lista_botones"><li id="grafica" class="transporte">Ver Grafica</li></ul>        
        <ul class="lista_botones"><li id="excel" class="transporte">Ver Excel</li></ul>
        <ul class="lista_botones"><li id="pdf" class="transporte">Ver Pdf</li></ul>
        <ul class="lista_botones"><li id="html" class="transporte">Ver Html</li></ul>  
    </div> 
    
    
    <span style="float:left;width:80%;text-align:left;font-size:14px;margin-top:40px;">
    Indicadores Servicios de Transporte  para el año <?php echo $anio_ini;?>
    </span>	
