...
<div id="frmBusqueda" >
    ...
    <div id="botonBusqueda">
            <ul id="imprimirGuiarem" class="lista_botones"><li id="imprimir">Imprimir</li></ul>
            <ul id="nuevaGuiarem" class="lista_botones"><li id="nuevo">Nueva G. de Remisión</li></ul>
            <ul id="limpiarGuiarem" class="lista_botones"><li id="limpiar">Limpiar</li></ul>
            <ul id="buscarGuiarem" class="lista_botones"><li id="buscar">Buscar</li></ul> 
    </div>
    <div id="lineaResultado">
        <table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
        <tr>
            <td width="50%" align="left">N de guias de remision encontrados:&nbsp;<?php echo $registros;?> </td>
    ...
    <div id="frmResultado">
        <table class="fuente8" width="100%" cellspacing="0" cellpadding="3" border="0" ID="Table1">
            <tr class="cabeceraTabla">
                    ...
                    <td width="8%">C.SALIDA</td>
                    <td width="15%">ALMACEN</td>
                    <td width="38%">RAZON SOCIAL</td>
                    <td width="5%">&nbsp;</td>
                    <td width="5%">&nbsp;</td>
                    <td width="5%">&nbsp;</td>
                    <td width="5%">&nbsp;</td>
