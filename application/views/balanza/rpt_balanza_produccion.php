...
<body>
    ...
    <div style = "display:table; width:200%; border:0px solid #000;">
	<br><br>
    ...
    <div style = "float: left; height:50px; width: 99.97%;">
		...
		<THEAD>
            <tr class="cabeceraTabla" align='center' style="height:50px;">
                ...
                <td style='width:4.65%;'><div>N&#176; OS</div></td>
                <td style='width:5.33%;'><div>FECHA INGRESO</div></td>                
                <td style='width:16.06%;'><div>NOMBRE CLIENTE</div></td>
                <td style='width:11%;'><div>MATERIAL</div></td>
                <td style='width:5.47%;'><div>N&#176; PIEZAS</div></td>
                <td style='width:8.27%;'><div>N&#176; CONST. RECEP</div></td>
                <td style='width:6.36%;'><div>N&#176; GUIA CLIENTE</div></td>
                <td style='width:7.18%;'><div>CLASIFICACION</div></td>
                <td style='width:4.10%;'><div>ESTADO</div></td>
                <td style='width:4.10%;'><div>PESO</div></td>
                <td style='width:12.30%;'><div>OBSERVACIONES</div></td>
                <td style='width:7.93%;'><div>N&#176; GUIA MIMCO</div></td>
                <td style='width:7.25%;'><div>F. DESPACHO</div></td>
    ...
    <div  id='detalle'  style = " overflow-x: hidden; float: left; height: 370px;overflow: auto; width: 99.99%;">
       <!--table border='1' style='width:98.3%;' id='tabla_detalle' class='tabla_cabecera'   Para iexplore6-->
       <table border='1' style='width:100%; height: 100%;' id='tabla_detalle' class='tabla_cabecera'>
